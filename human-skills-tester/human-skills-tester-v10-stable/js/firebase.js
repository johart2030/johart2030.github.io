...
import { getFirestore, doc, getDoc, setDoc, updateDoc, deleteDoc, runTransaction, serverTimestamp, collection, collectionGroup, query, orderBy, limit, getDocs, where } from "https://www.gstatic.com/firebasejs/12.18.0/firebase-firestore.js";
...
export { onAuthStateChanged, signOut, GoogleAuthProvider, signInWithPopup, signInWithRedirect, getRedirectResult, createUserWithEmailAndPassword, signInWithEmailAndPassword, sendPasswordResetEmail, sendEmailVerification, updateProfile, deleteUser, reauthenticateWithPopup, signInWithCredential, signInAnonymously, doc, getDoc, setDoc, updateDoc, deleteDoc, runTransaction, serverTimestamp, collection, collectionGroup, query, orderBy, limit, getDocs, where, ref, set, update, remove, get, onValue, onDisconnect, rtdbTimestamp, push, runRTDBTransaction };
